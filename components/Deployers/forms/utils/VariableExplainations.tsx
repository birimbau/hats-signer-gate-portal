	...
	return (
		<VStack height="100%" alignItems="flex-start" gap={"8px"} mt="18px">
			<Text>
				...
				signers. Note: once added as a valid signer, a Hat cannot be
				removed from the multisig.
			</Text>
			<Text>
			...
			<Text>
				<b>Max Signers</b> is the maximum number of addresses that can
				claim signing authority on the Safe.
			</Text>
			<Text>
				<b>Max Signers</b> is the maximum number of addresses that can
				claim signing authority on the Safe.
			...
			<Text>
				In order to execute a transaction, the safe must have a number
				of valid hat-wearing signers &gt;= Min Threshold. Each valid
				signer added beyond the Min Threshold will increase the
				safe&apos;s threshold until the Max Threshold is reached, after
				which the Safe&apos;s threshold will not increase.
			</Text>
		</VStack>
	);
}
